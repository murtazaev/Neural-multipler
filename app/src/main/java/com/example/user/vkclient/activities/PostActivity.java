...
public class PostActivity extends AppCompatActivity implements PostActivityMVP.View, View.OnClickListener, CheckCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerComments.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager.VERTICAL, true));
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                Intent i = new Intent();
                i.putExtra("feedResponse", vkFeedObject);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.repost:
                ...
                repostDialog.show(getFragmentManager(), "repostDialog");
                break;
    ...
    private void  initViews() {
        ...
        loadMoreComm = findViewById(R.id.load_more_comments);
        postImage = findViewById(R.id.post_image);
        send = findViewById(R.id.send);
        massageForComm = findViewById(R.id.massage_for_comm);
        textPost = findViewById(R.id.textPost);
        setLike = findViewById(R.id.set_like);
        reposts = findViewById(R.id.repost);
        countLikes = findViewById(R.id.count_like);
        countReposts = findViewById(R.id.count_repost);
    ...
    private void initFields() {
        ...
        vkFeedObject = getIntent().getParcelableExtra("feedResponse");
    }
                        ...
                        switch (which) {
                            case 0:
                                if (!editText.getText().toString().equals("")) {
                                    ...
                                    Toast.makeText(PostActivity.this, "Введите текст.", Toast.LENGTH_SHORT).show();
                                break;
                            case 1:
                                presenter.deleteComment(vkFeedObject.getSource_id(), commId, commCheck, position);
                                Toast.makeText(PostActivity.this, "Удаление", Toast.LENGTH_SHORT).show();
                                break;
                        }
                    }
                }).show();
